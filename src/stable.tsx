...
import { Trash2, Plus, X, ChevronDown, ChevronUp, Repeat, ChevronLeft, ChevronRight } from 'lucide-react';
                            ...
                            <div className="p-2 space-y-2">
                              ...
                              <div className="relative">
                                ...
                                {filteredIngredients.length > 0 && (
                                  <ul
                                    ref={dropdownRef}
                                    className="absolute z-50 w-full bg-white rounded-md mt-1 max-h-60 overflow-auto shadow-lg ingredient-dropdown"
                                  >
